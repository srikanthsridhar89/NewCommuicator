...
public class DisputeDetailPage {
	...
	By AdminSentInquiryButton=By.xpath("//button[contains(text(),'Send Inquiry')]");
	...
	By AdminSentInquirytoPayeeLocator=By.xpath("//span[2]//input[@aria-checked='false']");
	...
	public void click_ManagerSentInquiry(){
	...
	public void click_AdminSentInquirytoManager(){
		
		SeleniumMethods.click(AdminSentInquiryButton, "Click on Send Inquiry Button");
