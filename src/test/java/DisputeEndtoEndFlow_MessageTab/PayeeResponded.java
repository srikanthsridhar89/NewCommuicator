...
public class PayeeResponded {
	@BeforeClass
	public  void setUp() throws Exception
	{
		SeleniumMethods.initilization("PayeeResponded");
	}
	
	@Test

public void PayeeResponded_ManagerInquiry(){
	...
	try{
		...
		salesperformancehome.click_Logout();
		SeleniumMethods.staticwait(3000);
		//Login into SalesPortal and Enter User details 
		loginPage.Login(JsonReader.readJson("envconfig","UserName"),JsonReader.readJson("envconfig","Password"));
		//Click on Login
		loginPage.click_login();
		//Verify HomePage
