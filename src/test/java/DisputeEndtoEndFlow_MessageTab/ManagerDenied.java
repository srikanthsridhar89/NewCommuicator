...
public class ManagerDenied {
	...
	public class Denied {
		...
		{
			SeleniumMethods.initilization("Manager Denied");
		}
		
		@Test

	public void Dispute_Denial(){
		...
		try{
			...
			//EnterComments
			DisputeDetail.typecomments(JsonReader.readJson("Dispute//Disputeinput","ManagerDenyComments"));
			//Click on Ok
