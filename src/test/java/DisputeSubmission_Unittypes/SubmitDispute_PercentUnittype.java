...
public class SubmitDispute_PercentUnittype {
	@BeforeClass
	public  void setUp() throws Exception
	{
		SeleniumMethods.initilization("SubmitDispute_PercentUnittype");
	}
	...
	public void SubmitDispute_Incentive(){
		...
		try{
			...
			//Select Percent Unit type
		
			DisputeCreation.type_PercentRequestAmount();
			DisputeCreation.SelectRequestAmount_Percent();
