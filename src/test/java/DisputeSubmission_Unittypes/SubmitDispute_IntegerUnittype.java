...
public class SubmitDispute_IntegerUnittype {
	@BeforeClass
	public  void setUp() throws Exception
	{
		SeleniumMethods.initilization("SubmitDispute_IntegerUnittype");
	}
	...
	public void SubmitDispute_Incentive(){
		...
		try{
			...
			//Select Integer Unit type
		
			DisputeCreation.type_IntegerRequestAmount();
			DisputeCreation.SelectRequestAmount_Integer();
