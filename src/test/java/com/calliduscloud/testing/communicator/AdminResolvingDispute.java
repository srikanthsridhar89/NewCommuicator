...
public class AdminResolvingDispute {
	...
	public void SubmitDispute_Incentive(){
		...
		//Click on Logout
			...
			//Enter Comments
			DisputeDetail.typecomments(JsonReader.readJson("envconfig","AdminResolvedComments"));
			//Click on Ok 
			DisputeDetail.click_Okbutton();
			//Click on Cancel
			...
			//Verify AdminResolved
			DisputeDetail.check_DisputeDetail();
			Assert.assertEquals("Accepted",MyDisp.Get_AcceptedStatusText());
