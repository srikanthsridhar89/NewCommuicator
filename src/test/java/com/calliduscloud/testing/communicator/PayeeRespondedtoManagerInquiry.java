	...
	public class ManagerInquirytoPayee {
		...
		public void ManagerSentInquiry(){
			...
			try{
				...
				DisputeDetail.click_ManagerSentInquiry();
				//EnterComments
				DisputeDetail.typecomments(JsonReader.readJson("envconfig","ManageInquiryComments"));
				//Click on Ok
				...
				//Enter Comments
				DisputeDetail.typecomments(JsonReader.readJson("envconfig","PayeeRespondComments"));
				//Click on Ok
				DisputeDetail.click_Okbutton();
