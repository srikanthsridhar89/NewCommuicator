...
public class AdminSentInquiryManager {
	@BeforeClass
	...
	public void Admin_InquirytoManager(){
		...
		//Click on Logout
			...
			//EnterComments
			DisputeDetail.typecomments(JsonReader.readJson("envconfig","ManageApprovalComments"));
			//Click on Ok
			...
			DisputeDetail.click_AdminSentInquirytoManager();
			//Enter Comments
			DisputeDetail.typecomments(JsonReader.readJson("envconfig","AdminSentInquirytoManagerComments"));
			//Click on Ok 
			DisputeDetail.click_Okbutton();
			//Click on Cancel
			...
			//Verify AdminSentInquiry to Manager
			DisputeDetail.check_DisputeDetail();
