...
public class AdminSentInquirytoPayee {
	...
	public void Admin_InquirytoManager(){
		...
		//Click on Logout
			...
			//Click on Dispute Detail
			DisputeDetail.Click_DisputeDetail();
			//Click on Inquiry Button for Payee
			DisputeDetail.click_AdminSentInquirytoPayee();
			//Enter Comments
			DisputeDetail.typecomments(JsonReader.readJson("envconfig","AdminSentInquirytoPayeeComments"));
			//Click on Ok 
			DisputeDetail.click_Okbutton();
			//Click on Cancel
